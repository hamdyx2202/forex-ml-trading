...
def fix_database_paths():
    """تحديث جميع المسارات من forex_ml.db إلى forex_ml.db"""
    ...
    for file_path in set(files_to_update + all_python_files):
        ...
        try:
            ...
            replacements = [
                ('data/forex_ml.db', 'data/forex_ml.db'),
                ('"data/forex_ml.db"', '"data/forex_ml.db"'),
                ("'data/forex_ml.db'", "'data/forex_ml.db'"),
                ('Path("data/forex_ml.db")', 'Path("data/forex_ml.db")'),
                ('forex_ml.db', 'forex_ml.db'),  # أي إشارة أخرى
            ]
